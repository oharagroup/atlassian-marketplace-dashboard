...
Responsive, mobile-friendly SvelteKit app that pulls data from the Atlassian Marketplace API for add-on sales, and displays the results as a set of cards.
